...
sudo \cp -r /home/pi/console-modules/themeRetroBox/hdmi_version /etc/emulationstation/themes/retrobox_theme
sudo \cp -r /home/pi/console-modules/themeRetroBox/smallscreen_version/ /etc/emulationstation/themes/retrobox_smalltheme
