...
sudo \cp -r /home/pi/console-modules/all_version/themeRetroBox/hdmi_version /etc/emulationstation/themes/retrobox_theme
sudo \cp -r /home/pi/console-modules/all_version/themeRetroBox/smallscreen_version/ /etc/emulationstation/themes/retrobox_smalltheme
