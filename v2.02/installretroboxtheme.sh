...
sudo \cp -r /home/pi/console-modules/v2.02/themeRetroBox/hdmi_version /etc/emulationstation/themes/retrobox_theme
sudo \cp -r /home/pi/console-modules/v2.02/themeRetroBox/smallscreen_version/ /etc/emulationstation/themes/retrobox_smalltheme
