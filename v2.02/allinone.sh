...
sudo wget -N https://raw.githubusercontent.com/retrobox/console-modules/master/v2.02/installnode && sudo chmod +x /home/pi/installnode.sh && sudo ./installnode.sh
...
sudo wget -N https://raw.githubusercontent.com/retrobox/console-modules/master/v2.02/overlay.sh && sudo chmod +x /home/pi/overlay.sh && sudo ./overlay.sh
cd /home/pi/
