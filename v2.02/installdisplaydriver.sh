...
sudo wget -N https://raw.githubusercontent.com/retrobox/console-modules/master/v2.02/displayDriver/config.txt
...
cd /home/pi/
sudo wget -N https://raw.githubusercontent.com/retrobox/console-modules/master/v2.02/displayDriver/rc.local
